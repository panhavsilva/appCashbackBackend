...
const routes = Router();
import products from '@controllers/ts/products-controller';
import cashbackRanges from '@controllers/ts/cashback-controller';
import orders from '@controllers/ts/orders-controller';
